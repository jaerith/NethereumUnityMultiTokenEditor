...
namespace Nethereum.Contracts.UnityERC1155
{
    public partial class UnityERC1155Service : MonoBehaviour
    {
        ...
        {
            return web3.Eth.GetContractDeploymentHandler<UnityERC1155Deployment>().SendRequestAndWaitForReceiptAsync(myERC1155Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, UnityERC1155Deployment myERC1155Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<UnityERC1155Deployment>().SendRequestAsync(myERC1155Deployment);
        }

        public static async Task<UnityERC1155Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, UnityERC1155Deployment myERC1155Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, myERC1155Deployment, cancellationTokenSource);
            return new UnityERC1155Service(web3, receipt.ContractAddress);
        }
        ...
        public UnityERC1155Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
